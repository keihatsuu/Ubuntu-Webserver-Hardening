#!/bin/bash
# Week 2 - Defense in Depth compliance script
# Revised to match the Week 2 lab requirements and the settings that pass
# Week2_Confirmation_Script.sh in this lab environment.
...
echo "============================================================"
echo "          Week 2 - Webserver Hardening"
echo "============================================================"
...
# The lab confirmation script looks for /run/shm followed by noexec then nosuid.
...
# Updated Week 2 manual list. squashfs is intentionally omitted.
